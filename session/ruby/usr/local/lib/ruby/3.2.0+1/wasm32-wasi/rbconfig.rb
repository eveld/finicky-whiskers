...
module RbConfig
  ...
  CONFIG["configure_args"] = " '--host' 'wasm32-unknown-wasi' '--build' 'x86_64-pc-linux-gnu' '--with-static-linked-ext' '--with-ext=bigdecimal,cgi/escape,continuation,coverage,date,dbm,digest/bubblebabble,digest,digest/md5,digest/rmd160,digest/sha1,digest/sha2,etc,fcntl,fiber,gdbm,json,json/generator,json/parser,nkf,objspace,pathname,psych,racc/cparse,rbconfig/sizeof,ripper,stringio,strscan,monitor' '--with-libyaml-dir=/build/build/deps/wasm32-unknown-wasi/opt/libyaml/usr/local' 'LDFLAGS=-Xlinker -zstack-size=16777216' 'XLDFLAGS=/opt/wasi-vfs/lib/libwasi_vfs.a /build/build/ext-build/head-wasm32-unknown-wasi-full/extinit.o' 'debugflags=-g0' '--disable-install-doc' 'build_alias=x86_64-pc-linux-gnu' 'host_alias=wasm32-unknown-wasi'"
